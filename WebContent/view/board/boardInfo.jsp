...
<div class="container">
			...
			<tr>
			<th>작성자: </th><td><%=b.getWriter() %></td>
			</tr>
			<tr>
			<th>제목: </th><td><%=b.getSubject() %></td>
			</tr>
			<tr>
			<th height ="250px">내용: </th><td><%=b.getContent() %></td>
			</tr>
			<tr>
			<th>파일: </th><td><img src = "<%=request.getContextPath() %>/boardupload/<%=b.getFile1() %>"></td>
			</tr>
			</table>
